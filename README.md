...
- **Авторизация:** http://localhost:5173/login
...
3. Управляйте:
   - **Сотрудниками** - добавляйте всю информацию о сотрудниках
   - **Компаниями** - создавайте компании и добавляйте комментарии
   - **Площадками** - создавайте площадки и добавляйте комментарии